...
public class MainFragment extends Fragment implements OnTopicClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext())); // ask from fragment what is your activity
    ...
    public void onTopicClick(Topic topic) {
        TopicsViewModel model = new ViewModelProvider(requireActivity()).get(TopicsViewModel.class); // fixed by adding some new lines to Gradle
